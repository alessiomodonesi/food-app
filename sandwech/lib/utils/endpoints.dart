...
const getProductUrl =
    "http://IP_VM:8081/API/product/getProduct.php?PRODUCT_ID=";
const getProductTagUrl =
    "http://IP_VM:8081/API/tag/product-tag/getArchiveProductTag.php?tag_id=";
const getArchieveIngredientsUrl =
    "http://IP_VM:8081/API/product/getArchiveIngredients.php?panino=";
const postSignUpUrl = "http://IP_VM:8081/API/user/registration.php";
const addItemCartUrl = "http://IP_VM:8081/API/cart/setAddItem.php";
*/